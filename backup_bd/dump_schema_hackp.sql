...
--
-- Name: Avaliacao_Politico; Type: TABLE; Schema: public; Owner: defense; Tablespace: 
--

CREATE TABLE "Avaliacao_Politico" (
    "id_Usuario" integer NOT NULL,
    "id_Politico" character varying NOT NULL,
    "Thumb" integer NOT NULL
);


ALTER TABLE public."Avaliacao_Politico" OWNER TO defense;

--
-- Name: Avaliacao_Proposta; Type: TABLE; Schema: public; Owner: defense; Tablespace: 
--

CREATE TABLE "Avaliacao_Proposta" (
...
ALTER TABLE public."Avaliacao_Proposta" OWNER TO defense;

--
-- Name: Cargos; Type: TABLE; Schema: public; Owner: defense; Tablespace: 
--
...
ALTER TABLE public."Cargos" OWNER TO defense;

--
-- Name: Categorias; Type: TABLE; Schema: public; Owner: defense; Tablespace: 
--
...
ALTER TABLE public."Categorias" OWNER TO defense;

--
-- Name: Cidades; Type: TABLE; Schema: public; Owner: defense; Tablespace: 
--
...
ALTER TABLE public."Cidades" OWNER TO defense;

--
-- Name: Estados; Type: TABLE; Schema: public; Owner: defense; Tablespace: 
--
...
ALTER TABLE public."Estados" OWNER TO defense;

--
-- Name: Partido; Type: TABLE; Schema: public; Owner: defense; Tablespace: 
--
...
ALTER TABLE public."Partido" OWNER TO defense;

--
-- Name: Politico; Type: TABLE; Schema: public; Owner: defense; Tablespace: 
--
...
CREATE TABLE "Politico" (
    ...
    slogan character varying(130),
    introducao character varying(600),
    video_intro character varying(100),
    avaliacao integer,
    bio_titulo character varying(100)
);


ALTER TABLE public."Politico" OWNER TO defense;

--
-- Name: COLUMN "Politico"."Situacao"; Type: COMMENT; Schema: public; Owner: defense
--

COMMENT ON COLUMN "Politico"."Situacao" IS '1- Disputando; 2- Eleito; 3- Nao Eleito';


--
-- Name: Proposta; Type: TABLE; Schema: public; Owner: defense; Tablespace: 
--

CREATE TABLE "Proposta" (
    "id_Politico" character varying,
    "id_Proposta" integer NOT NULL,
...
ALTER TABLE public."Proposta" OWNER TO defense;

--
-- Name: Usuario; Type: TABLE; Schema: public; Owner: defense; Tablespace: 
--
...
ALTER TABLE public."Usuario" OWNER TO defense;

--
-- Name: COLUMN "Usuario"."Flag"; Type: COMMENT; Schema: public; Owner: defense
--

COMMENT ON COLUMN "Usuario"."Flag" IS '1- Nao-candidato; 2- Candidato/Politico';


--
-- Name: COLUMN "Usuario"."Genero"; Type: COMMENT; Schema: public; Owner: defense
--

COMMENT ON COLUMN "Usuario"."Genero" IS 'M/F';


--
-- Name: COLUMN "Usuario"."id_Origem"; Type: COMMENT; Schema: public; Owner: defense
--

COMMENT ON COLUMN "Usuario"."id_Origem" IS 'So para casar com o ID de outra origem como o face ou twitter.';


--
-- Name: COLUMN "Usuario"."Origem"; Type: COMMENT; Schema: public; Owner: defense
--

COMMENT ON COLUMN "Usuario"."Origem" IS 'O nome da fonte de origem de fato.';


--
-- Data for Name: Avaliacao_Politico; Type: TABLE DATA; Schema: public; Owner: defense
--

COPY "Avaliacao_Politico" ("id_Usuario", "id_Politico", "Thumb") FROM stdin;
\.


--
-- Data for Name: Avaliacao_Proposta; Type: TABLE DATA; Schema: public; Owner: defense
--

COPY "Avaliacao_Proposta" ("id_Proposta", "Nota", "id_Usuario") FROM stdin;
\.


--
-- Data for Name: Cargos; Type: TABLE DATA; Schema: public; Owner: defense
--

COPY "Cargos" ("id_Cargo", "Nome") FROM stdin;
1	Presidente
2	Governador
3	Prefeito
4	Deputado Federal
5	Senador
6	Deputado Estadual
7	Deputado Distrital
8	Vereador
\.


--
-- Data for Name: Categorias; Type: TABLE DATA; Schema: public; Owner: defense
--

COPY "Categorias" ("id_Categoria", "Nome") FROM stdin;
1	Educação
2	Meio ambiente
3	Saúde
4	Segurança
...
--
-- Data for Name: Cidades; Type: TABLE DATA; Schema: public; Owner: defense
--

COPY "Cidades" ("UF", "Nome") FROM stdin;
...
--
-- Data for Name: Estados; Type: TABLE DATA; Schema: public; Owner: defense
--

COPY "Estados" ("Sigla", "Nome") FROM stdin;
...
--
-- Data for Name: Partido; Type: TABLE DATA; Schema: public; Owner: defense
--

COPY "Partido" ("Num_Partido", "Sigla") FROM stdin;
10	PRB
11	PP
12	PDT
13	PT
...
--
-- Data for Name: Politico; Type: TABLE DATA; Schema: public; Owner: defense
--

COPY "Politico" ("id_Usuario", "id_Politico", "Num_Partido", "Ano", "id_Cargo", "Imagem", "Num_Candidato", "Situacao", "Descricao", slogan, introducao, video_intro, avaliacao, bio_titulo) FROM stdin;
50	1	50	2016	1	http://www.diariodocentrodomundo.com.br/wp-content/uploads/2014/12/luciana-genro-3.jpg	50	1	Luciana iniciou sua trajetória política em 1985, aos 14 anos,[9] no Colégio Julio de Castilhos em Porto Alegre, quando entrou no movimento estudantil. Foi a partir deste momento que passou a ter contato com as mais diversas correntes internas do Partido dos Trabalhadores, organização a qual seu pai era filiado. Ainda que a convivência com a política tenha começado dentro de casa, Luciana sempre teve importantes divergências políticas com Tarso inclusive depois de também ingressar nas fileiras do PT. Foi também no Colégio Julinho que Luciana conheceu Roberto Robaina, seu parceiro político desde aquela época e com quem Luciana teve seu filho, Fernando. Ambos seguem na mesma organização, o Movimento Esquerda Socialista, tendência interna do PSOL.				1	
36	jeanwyllys	50	2018	4	http://kdfrases.com/imagens/jean-wyllys.jpg	5005	2	Jean Wyllys de Matos Santos é um político e escritor brasileiro, eleito em 2010 para mandato de deputado federal pelo PSOL do Rio de Janeiro a partir de fevereiro de 2011. Célebre por participar do programa Big Brother Brasil, da Rede Globo.	Antes de ser um notório militante do movimento gay, eu sou um defensor dos Direitos Humanos.	Antes de ser um notório militante do movimento gay, eu sou um defensor dos Direitos Humanos.	\N	-2	\N
40	mariadorosario	13	2014	4	http://blog.opovo.com.br/ancoradouro/wp-content/uploads/sites/2/2015/01/mariaROSARIO.jpg	1313	1	Maria do Rosário Nunes é uma professora e política brasileira. Exerceu o cargo de Ministra da Secretaria de Direitos Humanos da Presidência da República até 1º de abril de 2014, e ocupa atualmente uma cadeira na Câmara Federal	Deputada federal pelo RS.	Deputada federal pelo RS.		0	
35	bolsonaro	11	2018	1	https://pbs.twimg.com/profile_images/519544592949989377/uj4V88tA_400x400.jpeg	11	1	Jair Messias Bolsonaro (Campinas, 21 de março de 1955) é um militar da reserva e deputado federal brasileiro. Cumpre sua sexta legislatura na Câmara dos Deputados do Brasil, eleito pelo Partido Progressista e foi o deputado mais votado do estado do Rio de Janeiro nas eleições gerais de 2014, com apoio de 6% do eleitorado fluminense (464 mil votos).	Prefiro uma cadeia cheia de bandidos do que um cemiterio cheio de inocentes.	Jair Messias Bolsonaro (Campinas, 21 de março de 1955) é um militar da reserva e deputado federal brasileiro. Cumpre sua sexta legislatura na Câmara dos Deputados do Brasil, eleito pelo Partido Progressista e foi o deputado mais votado do estado do Rio de Janeiro nas eleições gerais de 2014, com apoio de 6% do eleitorado fluminense (464 mil votos).[3]	mtrOFe-GqFk	1253	Vida de honra
37	tarcisio	50	2014	2	http://s2.glbimg.com/ArA-4GISWv5zwFrFvrttjIJaQZo=/0x0:300x225/300x225/s.glbimg.com/jo/g1/f/original/2014/06/27/tarcisio-foto.jpg	50	1	Tarcísio Motta é candidato pelo PSOL ao cargo de Governador do Rio de Janeiro.	Beiçola	Tarcísio Motta é candidato pelo PSOL ao cargo de Governador do Rio de Janeiro.\n\nNascido em 1975 no município de Petrópolis, no Rio de Janeiro, Tarcísio Motta de Carvalho é mestre e doutor em História pela Universidade Federal Fluminense e leciona desde 2005 no Colégio Pedro II.\n\nIniciou sua vida política ainda como militante na Pastoral da Juventude e chegou a ocupar importantes cargos no Sindicato Estadual dos Profissionais de Educação. Tarcísio participou da fundação do atual partido, onde é filiado desde 2005.		0	
1323	chicoalencar50	50	2016	3	http://poderonline.ig.com.br/wp-content/uploads/2014/03/chicoalencar.png	50	1	Ligado à Teologia da Libertação, da esquerda católica, morador do bairro carioca de Santa Teresa, foi fundador e presidente da Associação de Moradores da Praça Sáenz Peña (AMOAPRA), e também diretor e presidente da Federação das Associações de Moradores do Estado do Rio de Janeiro (FAMERJ). Filiado ao PT, foi vereador no Rio de Janeiro por dois mandatos, de 1989-1992, e de 1993-1996.\n\nNa Câmara de Vereadores, foi um dos líderes na luta pela moralização da casa. Participou da elaboração da Lei Orgânica e da discussão do Plano Diretor da Cidade, quando apresentou sugestões e emendas reivindicadas pelos movimentos populares. Foi também presidente da Comissão de Educação e Cultura da Câmara Municipal do Rio de Janeiro. Teve aprovados mais de 30 projetos de lei, sempre voltados para a melhoria do serviços públicos e da qualidade de vida dos cidadãos. Em 1996, candidatou-se à prefeitura, ficando em 3º lugar, resultado considerado surpreendente à época. Mesmo boicotado pela direção nacional petista, Chico teve 642 mil votos, e não passou ao segundo turno por apenas 1,5%.	A lambança venceu a esperança.	Formado em história na Universidade Federal Fluminense, foi professor da disciplina no ensino fundamental e médio do Rio de Janeiro, nas redes pública e privada. Defendeu dissertação de mestrado em Educação na Fundação Getúlio Vargas sobre o movimento das Associações de Moradores do Rio, do qual foi um dos principais líderes no início dos anos 80.	jiOCSDyx5Yo	0	Uma vida de conquistas
56	tiririca	22	2014	4	http://poderonline.ig.com.br/wp-content/uploads/2011/10/IMG_1302.jpg	2222	1	Francisco Everardo Oliveira Silva[2] (Itapipoca, 1 de maio de 1965), conhecido pelo nome artístico de Tiririca ou intimamente como Taruroca do Nordeste, é um cantor, compositor, humorista, e político brasileiro. Filiado ao Partido da República, Tiririca foi eleito deputado federal por São Paulo, tendo sido o segundo deputado mais votado em toda a história do Brasil, atrás apenas de Enéas Carneiro.[3]	Deputado Federal por SP.	Deputado Federal por SP.	\N	14	\N
1000	100	20	2016	4	http://www.superpride.com.br/wp-content/uploads/2014/11/eduardo-bolsonaro-290.jpg	70	1	Alinhado com posições de direita,\nfiliado ao Partido Social Cristão, disputou o cargo de deputado federal nas eleições de São Paulo em 2014, elegendo-se com 82.224 votos.\nSuas principais propostas são a redução da maioridade penal, agronegócio contra invasões MST, fim do auxílio-reclusão para presos, trabalho obrigatório para presos, planejamento familiar (PEC 584/02), contra o desarmamento, valorização das forças armadas e a favor do livre-comércio	Deputado Federal SP	Deputado Federal SP	-	1	
\.


--
-- Data for Name: Proposta; Type: TABLE DATA; Schema: public; Owner: defense
--

COPY "Proposta" ("id_Politico", "id_Proposta", "Titulo", "Descricao", "Prazo", "id_Categoria", visualizacoes) FROM stdin;
chicoalencar50	13	Recuperação dos rios que cortam Curitiba	Realizando um grande programa de saneamento ambiental em parceria com a Sanepar sob a lideranca da prefeitura de Curitiba em conjunto com os municípios da região metropolitana. » Coletar 100% do lixo reciclável. » Apoiar as cooperativas de reciclagem. » Instituição do Programa de financiamento para a compra de equipamentos paras as cooperativas de reciclagem.	2017-12-10	2	0
jeanwyllys	4	Ensino do islamismo no Brasil	Entre os muitos projetos que tramitam no Congresso, um tem chamado atenção de parlamentares religiosos. O Projeto de Lei 1780/2011 propõe incluir no currículo oficial da rede de ensino “a obrigatoriedade da temática “cultura árabe e tradição islâmica”. Seu teor completo pode ser conhecido no site do Congresso (aqui).\n\nOriginalmente, foi uma proposta do deputado Miguel Côrrea (PT-MG), recebendo apoio de Carlos Alberto (PMN-RJ), Jean Willys (PSOL-RJ), Luiz Tibé (PT do B-MG), Edson Santos (PT-RJ) e Reginaldo Lopes (PT-MG).\n\nCausa estranheza a presença da assinatura do deputado Jean Willys, que tantas vezes apregoou a manutenção do Estado laico e classificou os ensinos do cristianismo de “homofóbicos”. De modo especial, por que sendo um defensor da população LGBT, parece esquecer que na maioria dos Estados islâmicos os gays ainda são mortos em consonância com a sharia (lei religiosa islâmica). Alguns nos atrás, quando Mahmoud Ahmadinejad, então presidente do Irã esteve no Brasil, deixou isso bem claro.	\N	1	\N
jeanwyllys	6	Legalizacao do Aborto	É preciso discutir, abertamente e de forma HONESTA sobre a necessidade de legalizar o aborto. O que NÃO significa que o deputado é A FAVOR de que aborto seja um mero método contraceptivo, ou um meio de controle familiar. Não é isso, e por isso a legalização do aborto deve vir acompanhada por políticas públicas de informação sobre os métodos contraceptivos e acesso gratuito a eles nos centros de saúde, educação sexual nas escolas, prevenção e combate ao estupro e à violência de gênero e outras formas de impedir a gravidez não desejada. Contudo, na última instância, quem deve decidir se continuar ou interromper a gravidez não desejada é a mulher. É um direito dela: gravidez não é destino, é escolha.\n\nPor outro lado, aborto é uma grave questão de saúde pública e precisa ser tratado como tal. Em nosso país, o aborto é a segunda maior causa de morte de gestantes, e isto ocorre independente de proibição ou criminalização . A mulher que pratica o aborto clandestino no Brasil não se encaixa em um só molde, a diferença é que aquelas sem condições financeiras que proporcionem acesso à assistência médica de qualidade, morrem – ou procuram, em vão, assistência da saúde pública. Ao mesmo tempo em que a proibição pura e simples não impede mulheres de abortarem, ela ainda as obriga a recorrer a chás perigosos, medicamentos contrabandeados e clínicas clandestinas, que funcionam, inclusive, com apoio de agentes federais.	\N	3	\N
chicoalencar50	8	Proibicao de uso de armas de fogo em manifestacoes	A Câmara dos Deputados analisa projeto de lei que busca evitar a violência policial durante as manifestações populares. De acordo com o projeto, será proibido o uso de armas de fogo, as de eletrochoque, as que têm munição de borracha, as bombas de efeito moral e armas químicas como o gás lacrimogêneo.\n\nO projeto também prevê que os agentes armados deverão ser acompanhados sempre, no exercício das atividades, por uma equipe de agentes desarmados e especializados na mediação de conflitos, visando à solução pacífica.\n\nO autor do projeto, deputado Chico Alencar (PSol-RJ), apresenta os detalhes da proposta.	\N	4	\N
\.


--
-- Data for Name: Usuario; Type: TABLE DATA; Schema: public; Owner: defense
--

COPY "Usuario" ("id_Usuario", "Nome", "UF", "Cidade", "Flag", "Genero", "id_Origem", "Origem") FROM stdin;
1	ANTONIO CARLOS PCO	RJ	Rio de Janeiro	2	\N	\N	\N
2	ASPASIA	RJ	Rio de Janeiro	2	\N	\N	\N
3	CYRO GARCIA	RJ	Rio de Janeiro	2	\N	\N	\N
4	EDUARDO PAES	RJ	Rio de Janeiro	2	\N	\N	\N
5	FERNANDO SIQUEIRA	RJ	Rio de Janeiro	2	\N	\N	\N
6	MARCELO FREIXO	RJ	Rio de Janeiro	2	\N	\N	\N
7	OTAVIO LEITE	RJ	Rio de Janeiro	2	\N	\N	\N
8	RODRIGO MAIA	RJ	Rio de Janeiro	2	\N	\N	\N
9	CORONEL RABELO	RJ	Rio de Janeiro	2	\N	\N	\N
10	ADALGISA HYODO	RJ	Rio de Janeiro	2	\N	\N	\N
11	PROFESSOR ADALMIR	RJ	Rio de Janeiro	2	\N	\N	\N
12	DARIO GRANDE	RJ	Rio de Janeiro	2	\N	\N	\N
13	ADEIR APOLINARIO	RJ	Rio de Janeiro	2	\N	\N	\N
14	JAIR DA MENDES GOMES	RJ	Rio de Janeiro	2	\N	\N	\N
15	SARGENTO FELIZARDO	RJ	Rio de Janeiro	2	\N	\N	\N
16	ADELSON GUEDES	RJ	Rio de Janeiro	2	\N	\N	\N
17	ADEMAR MADUREIRA	RJ	Rio de Janeiro	2	\N	\N	\N
18	DODA BRASIL	RJ	Rio de Janeiro	2	\N	\N	\N
19	ADEMIR BARROS	RJ	Rio de Janeiro	2	\N	\N	\N
20	ADILSON TAIPAN	RJ	Rio de Janeiro	2	\N	\N	\N
21	ADILSON ARAUJO	RJ	Rio de Janeiro	2	\N	\N	\N
22	CORONEL SOARES	RJ	Rio de Janeiro	2	\N	\N	\N
23	ADRIANA SANTOS	RJ	Rio de Janeiro	2	\N	\N	\N
24	ADRIANA ROCHA	RJ	Rio de Janeiro	2	\N	\N	\N
25	ADRIANA DE MEDEIROS PIROZI	RJ	Rio de Janeiro	2	\N	\N	\N
26	ADRIANA SILVEIRA	RJ	Rio de Janeiro	2	\N	\N	\N
27	ADRIANA DO ITA	RJ	Rio de Janeiro	2	\N	\N	\N
28	VICTOR MATHIAS	RJ	Rio de Janeiro	2	\N	\N	\N
31	GIANCARLLO ROJAS	MT	Nova Monte Verde	2	M	\N	\N
32	Jean Wyllys	RJ	Rio de Janeiro	2	M	3	facebook
33	BOLSOMITO	RJ	Rio de Janeiro	2	M	4	facebook
1323	Chico Alencar	RJ	Rio de Janeiro	2	Masculino	fsafji123u19310938019	facebook
35	Jair Bolsonaro	RJ	Rio de Janeiro	2	M		
36	Jean Wyllys	RJ	Rio de Janeiro	2	M		
37	Tarcisio	RJ	Rio de Janeiro	1	M		
40	Maria do Rosario	RS	Veranópolis	1	F		
50	Luciana Genro	RS	Porto Alegre	1	F	1	facebook
1000	Eduardo Bolsonaro	RJ	Rio de Janeiro	1	H	4	facebook
56	Tiririca	SP	São Paulo	2	M		
\.


--
-- Name: Avaliacao_Politico_pkey; Type: CONSTRAINT; Schema: public; Owner: defense; Tablespace: 
--

ALTER TABLE ONLY "Avaliacao_Politico"
    ADD CONSTRAINT "Avaliacao_Politico_pkey" PRIMARY KEY ("id_Usuario", "id_Politico");


--
-- Name: Avaliacao_Proposta_pkey; Type: CONSTRAINT; Schema: public; Owner: defense; Tablespace: 
--

ALTER TABLE ONLY "Avaliacao_Proposta"
    ADD CONSTRAINT "Avaliacao_Proposta_pkey" PRIMARY KEY ("id_Proposta", "id_Usuario");


--
-- Name: Cargos_pkey; Type: CONSTRAINT; Schema: public; Owner: defense; Tablespace: 
--
...
--
-- Name: Categorias_pkey; Type: CONSTRAINT; Schema: public; Owner: defense; Tablespace: 
--
...
--
-- Name: Cidades_pkey; Type: CONSTRAINT; Schema: public; Owner: defense; Tablespace: 
--

ALTER TABLE ONLY "Cidades"
    ADD CONSTRAINT "Cidades_pkey" PRIMARY KEY ("UF", "Nome");


--
-- Name: Estados_pkey; Type: CONSTRAINT; Schema: public; Owner: defense; Tablespace: 
--
...
--
-- Name: Partido_pkey; Type: CONSTRAINT; Schema: public; Owner: defense; Tablespace: 
--

ALTER TABLE ONLY "Partido"
    ADD CONSTRAINT "Partido_pkey" PRIMARY KEY ("Num_Partido");


--
-- Name: Politico_id_Politico_key; Type: CONSTRAINT; Schema: public; Owner: defense; Tablespace: 
--

ALTER TABLE ONLY "Politico"
    ADD CONSTRAINT "Politico_id_Politico_key" UNIQUE ("id_Politico");


--
-- Name: Politico_pkey; Type: CONSTRAINT; Schema: public; Owner: defense; Tablespace: 
--

ALTER TABLE ONLY "Politico"
    ADD CONSTRAINT "Politico_pkey" PRIMARY KEY ("id_Politico");


--
-- Name: Proposta_pkey; Type: CONSTRAINT; Schema: public; Owner: defense; Tablespace: 
--
...
--
-- Name: Usuario_pkey; Type: CONSTRAINT; Schema: public; Owner: defense; Tablespace: 
--
...
--
-- Name: Avaliacao_Politico_id_Politico_fkey; Type: FK CONSTRAINT; Schema: public; Owner: defense
--

ALTER TABLE ONLY "Avaliacao_Politico"
    ADD CONSTRAINT "Avaliacao_Politico_id_Politico_fkey" FOREIGN KEY ("id_Politico") REFERENCES "Politico"("id_Politico");


--
-- Name: Avaliacao_Politico_id_Usuario_fkey; Type: FK CONSTRAINT; Schema: public; Owner: defense
--

ALTER TABLE ONLY "Avaliacao_Politico"
    ADD CONSTRAINT "Avaliacao_Politico_id_Usuario_fkey" FOREIGN KEY ("id_Usuario") REFERENCES "Usuario"("id_Usuario");


--
-- Name: Avaliacao_Proposta_id_Proposta_fkey; Type: FK CONSTRAINT; Schema: public; Owner: defense
--

ALTER TABLE ONLY "Avaliacao_Proposta"
    ADD CONSTRAINT "Avaliacao_Proposta_id_Proposta_fkey" FOREIGN KEY ("id_Proposta") REFERENCES "Proposta"("id_Proposta");


--
-- Name: Avaliacao_Proposta_id_Usuario_fkey; Type: FK CONSTRAINT; Schema: public; Owner: defense
--

ALTER TABLE ONLY "Avaliacao_Proposta"
    ADD CONSTRAINT "Avaliacao_Proposta_id_Usuario_fkey" FOREIGN KEY ("id_Usuario") REFERENCES "Usuario"("id_Usuario");


--
-- Name: Cidades_UF_fkey; Type: FK CONSTRAINT; Schema: public; Owner: defense
--

ALTER TABLE ONLY "Cidades"
    ADD CONSTRAINT "Cidades_UF_fkey" FOREIGN KEY ("UF") REFERENCES "Estados"("Sigla");


--
-- Name: Politico_Num_Partido_fkey; Type: FK CONSTRAINT; Schema: public; Owner: defense
--

ALTER TABLE ONLY "Politico"
    ADD CONSTRAINT "Politico_Num_Partido_fkey" FOREIGN KEY ("Num_Partido") REFERENCES "Partido"("Num_Partido");


--
-- Name: Politico_id_Cargo_fkey; Type: FK CONSTRAINT; Schema: public; Owner: defense
--

ALTER TABLE ONLY "Politico"
    ADD CONSTRAINT "Politico_id_Cargo_fkey" FOREIGN KEY ("id_Cargo") REFERENCES "Cargos"("id_Cargo");


--
-- Name: Politico_id_Usuario_fkey; Type: FK CONSTRAINT; Schema: public; Owner: defense
--

ALTER TABLE ONLY "Politico"
    ADD CONSTRAINT "Politico_id_Usuario_fkey" FOREIGN KEY ("id_Usuario") REFERENCES "Usuario"("id_Usuario");


--
-- Name: Proposta_id_Categoria_fkey; Type: FK CONSTRAINT; Schema: public; Owner: defense
--

ALTER TABLE ONLY "Proposta"
    ADD CONSTRAINT "Proposta_id_Categoria_fkey" FOREIGN KEY ("id_Categoria") REFERENCES "Categorias"("id_Categoria");


--
-- Name: Proposta_id_Politico_fkey; Type: FK CONSTRAINT; Schema: public; Owner: defense
--

ALTER TABLE ONLY "Proposta"
    ADD CONSTRAINT "Proposta_id_Politico_fkey" FOREIGN KEY ("id_Politico") REFERENCES "Politico"("id_Politico");


--
-- Name: Usuario_UF_fkey; Type: FK CONSTRAINT; Schema: public; Owner: defense
--

ALTER TABLE ONLY "Usuario"
    ADD CONSTRAINT "Usuario_UF_fkey" FOREIGN KEY ("UF", "Cidade") REFERENCES "Cidades"("UF", "Nome");
...
--
-- Name: Politico.avaliacao; Type: ACL; Schema: public; Owner: defense
--

REVOKE ALL(avaliacao) ON TABLE "Politico" FROM PUBLIC;
REVOKE ALL(avaliacao) ON TABLE "Politico" FROM defense;
GRANT ALL(avaliacao) ON TABLE "Politico" TO defense;
GRANT ALL(avaliacao) ON TABLE "Politico" TO PUBLIC;
